(self["webpackChunkcap"] = self["webpackChunkcap"] || []).push([["src_app_tabpage_dashboard_dashboard_module_ts"],{
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ 46797);
...
NgCircleProgressModule.ɵmod = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({ type: NgCircleProgressModule });
NgCircleProgressModule.ɵinj = /*@__PURE__*/ _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ imports: [[
...
/***/ 46678:
/*!***************************************************************!*\
  !*** ./src/app/tabpage/dashboard/dashboard-routing.module.ts ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _dashboard_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard.page */ 5917);
...
/***/ 82163:
/*!*******************************************************!*\
  !*** ./src/app/tabpage/dashboard/dashboard.module.ts ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dashboard-routing.module */ 46678);
/* harmony import */ var _dashboard_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.page */ 5917);
...
/***/ 5917:
/*!*****************************************************!*\
  !*** ./src/app/tabpage/dashboard/dashboard.page.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _raw_loader_dashboard_page_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./dashboard.page.html */ 5492);
/* harmony import */ var _dashboard_page_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dashboard.page.scss */ 37969);
...
let DashboardPage = class DashboardPage {
    ...
    //   { XDOCNUM_0: "SRTDE0120009", XDOCTYP_0: 2, XCTY_0: "nine", XDLVDAT_0: "2021-07-14T11:56:52.847Z" },
    // ];
    constructor(utilService, routesService, route) {
        this.utilService = utilService;
        this.routesService = routesService;
        this.route = route;
        this.documentDetails = [];
        this.completeStops = 0;
        this.progress = 0;
    ...
    getDocumentDetails() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.routesService.getDocumentDetails(this.stopId).subscribe((resp) => {
    ...
    allStatus() {
        this.totalDrops = lodash__WEBPACK_IMPORTED_MODULE_4__.filter(this.documentDetails, { XDOCTYP_0: 1 });
        this.totalDrops = this.totalDrops.length;
        this.totalPickups = lodash__WEBPACK_IMPORTED_MODULE_4__.filter(this.documentDetails, { XDOCTYP_0: 2 });
    ...
    // }
    todayStatusJob() {
        this.todayTotalDrops = lodash__WEBPACK_IMPORTED_MODULE_4__.filter(this.documentDetails, (todayDrop) => {
            return todayDrop.XDOCTYP_0 == 1 && moment__WEBPACK_IMPORTED_MODULE_5__(todayDrop.XDLVDAT_0).format('YYYY-MM-DD') == moment__WEBPACK_IMPORTED_MODULE_5__().format('YYYY-MM-DD');
        });
        this.todayTotalDrops = this.todayTotalDrops.length;
        this.todayTotalPickups = lodash__WEBPACK_IMPORTED_MODULE_4__.filter(this.documentDetails, (todayPickup) => {
            return todayPickup.XDOCTYP_0 == 2 && moment__WEBPACK_IMPORTED_MODULE_5__(todayPickup.XDLVDAT_0).format('YYYY-MM-DD') == moment__WEBPACK_IMPORTED_MODULE_5__().format('YYYY-MM-DD');
        });
...
/***/ 37969:
/*!*******************************************************!*\
  !*** ./src/app/tabpage/dashboard/dashboard.page.scss ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (".summary-header {\n  background: var(--ion-color-dark);\n}\n.summary-header .overall-status {\n  width: 180px;\n  height: 180px;\n  margin: 15px auto;\n}\n.summary-header .pickup-drops {\n  background: var(--ion-color-primary);\n}\n.summary-header .pickup-drops ion-card-title,\n.summary-header .pickup-drops ion-card-subtitle {\n  color: var(--ion-color-tertiary);\n}\n.today-job-status {\n  background: var(--ion-color-dark);\n  border-radius: 8px;\n  padding: 8px;\n  color: var(--ion-color-tertiary);\n}\n.today-job-status h2 {\n  font-weight: 600;\n  font-size: 18px;\n}\n.today-job-status h2 span {\n  color: #24a859;\n}\n.today-job-status ion-col:nth-child(2) {\n  border-left: 1px solid var(--ion-color-tertiary-shade);\n  border-right: 1px solid var(--ion-color-tertiary-shade);\n}\n/*# sourceMappingURL=data:application/json;base64, */");

/***/ }),

/***/ 5492:
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/tabpage/dashboard/dashboard.page.html ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-content color=\"tertiary\">\r\n    <ion-row class=\"summary-header p-5\">\r\n        <ion-col size=\"12\">\r\n            <div class=\"overall-status\">\r\n                <circle-progress [percent]=\"progress\"></circle-progress>\r\n            </div>\r\n        </ion-col>\r\n        <ion-col size=\"6\">\r\n            <ion-card class=\"pickup-drops m-5\">\r\n                <ion-card-header class=\"ion-text-center p-5\">\r\n                    <ion-card-title>{{ totalDrops }}</ion-card-title>\r\n                    <ion-card-subtitle>Total Drops</ion-card-subtitle>\r\n                </ion-card-header>\r\n            </ion-card>\r\n        </ion-col>\r\n        <ion-col size=\"6\">\r\n            <ion-card class=\"pickup-drops m-5\">\r\n                <ion-card-header class=\"ion-text-center p-5\">\r\n                    <ion-card-title>{{ totalPickups }}</ion-card-title>\r\n                    <ion-card-subtitle>Total Pickups</ion-card-subtitle>\r\n                </ion-card-header>\r\n            </ion-card>\r\n        </ion-col>\r\n    </ion-row>\r\n    <ion-list-header>\r\n        <ion-label class=\"fs-18\">Status Job Today</ion-label>\r\n    </ion-list-header>\r\n    <ion-grid class=\"ion-padding-start ion-padding-end\">\r\n        <ion-row class=\"today-job-status\">\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2>{{ todayTotalDrops }}</h2>\r\n                    <p>Drops</p>\r\n                </ion-label>\r\n            </ion-col>\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2>{{ todayTotalPickups }}</h2>\r\n                    <p>Pickups</p>\r\n                </ion-label>\r\n            </ion-col>\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2>0</h2>\r\n                    <p>On Time</p>\r\n                </ion-label>\r\n            </ion-col>\r\n        </ion-row>\r\n    </ion-grid>\r\n    <ion-list-header>\r\n        <ion-label class=\"fs-18\">Trip Summary</ion-label>\r\n    </ion-list-header>\r\n    <ion-grid class=\"ion-padding-start ion-padding-end\">\r\n        <ion-row class=\"today-job-status\">\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2><span>15</span>/250</h2>\r\n                    <p>Kilometers</p>\r\n                </ion-label>\r\n            </ion-col>\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2><span>4</span>/8.5</h2>\r\n                    <p>Hours Driving</p>\r\n                </ion-label>\r\n            </ion-col>\r\n            <ion-col size=\"4\">\r\n                <ion-label class=\"ion-text-center\">\r\n                    <h2><span>{{ completeStops }}</span>/{{ totalStops }}</h2>\r\n                    <p>Stops</p>\r\n                </ion-label>\r\n            </ion-col>\r\n        </ion-row>\r\n    </ion-grid>\r\n</ion-content>");

/***/ })

}]);
//# sourceMappingURL=src_app_tabpage_dashboard_dashboard_module_ts.js.map